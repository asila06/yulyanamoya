...
const quizData = [
    {
        ...
        options: ["3 Мая ", "2 Мая вечером", "1 Мая ", "20 Мая"],
        correct: 1
    },
    {
        question: "Во сколько был наш первый звонок по телефону",
        options: ["21:28", "23:32", "Да я вообще не помню", "21:23"],
        correct: 0
    },
    {
        question: "Какого числа у меня ДР",
        options: ["14 декабря", "15 декбря", "16 декабря", "18 декабря"],
        correct: 1
    },
    {
        question: "Как будет на УЗБ на тебя похож",
        options: ["Санга охшима", "Озинга охшатма", "Ами тилла", "Санга нма"],
        correct: 1
    },
    {
        question: "Кто я по нации",
        options: ["EURO uzbek", "Узбек", "Метист", "Англичанин"],
        correct: 0
    },
    {
        question: "Значение слова СОЛЭ",
        options: ["Солиха какая то", "Французская еда ", "Что то на италиано", ""],
        correct: 1
    }
];
